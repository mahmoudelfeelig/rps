...
const items = [
  ...
  { name:'Lucky Clover', emoji:'🍀', type:'power-up', effect:'+15% win chance in Slots',
    ...
    image:'clover.png', description:'Boost your slots luck for the next spin.' },
  ...
  { name:'Ladybug Charm', emoji:'🐞', type:'power-up', effect:'+20% win chance in Slots',
    ...
    image:'ladybug.png', description:'Carry this lucky insect to improve your odds.' },
  ...
  { name:'Rainbow Dice', emoji:'🎲', type:'power-up', effect:'+25% win chance in Slots',
    ...
    image:'rainbow_dice.png', description:'Colorful dice that tilt fortune in your favor.' },
  ...
  { name:'Safety Helmet', emoji:'⛑️', type:'power-up', effect:'+1 extra safe click',
    ...
    image:'helmet.png', description:'Wear this to survive one extra click in Minefield.' },
  ...
  { name:'Guardian Shield', emoji:'🛡️', type:'power-up', effect:'+2 extra safe clicks',
    ...
    image:'shield.png', description:'A protective shield granting two extra safe clicks.' },
  ...
  { name:'Eagle Eye Goggles', emoji:'🦅', type:'power-up', effect:'+3 extra safe clicks',
    ...
    image:'goggles.png', description:'See through danger for three guaranteed safe clicks.' },
  ...
  { name:'Divine Protection', emoji:'🕊️', type:'power-up', effect:'+5 extra safe clicks',
    ...
    image:'dove.png', description:'A heavenly blessing: five extra safe clicks.' },
  ...
  { name:'Mine Sweeper', emoji:'🧹', type:'power-up', effect:'–3 mines at start',
    ...
    image:'sweeper.png', description:'Clear three mines before you even begin.' },
  ...
  { name:'Ground Scan', emoji:'📡', type:'power-up', effect:'–5 mines at start',
    ...
    image:'scanner.png', description:'Scan and remove five mines from the field.' },
  ...
  { name:'Mine Nullifier', emoji:'💥', type:'power-up', effect:'–7 mines at start',
    ...
    image:'nullifier.png', description:'Nullify seven mines instantly.' },
  ...
  { name:'Terraformer', emoji:'🌱', type:'power-up', effect:'–10 mines at start',
    ...
    image:'terraformer.png', description:'Re‑shape the ground to remove ten mines.' },
  ...
  { name:'VIP Multiplier', emoji:'💎', type:'badge', effect:'+10% on all payouts',
    ...
    image:'vip.png', description:'Permanent 10% bonus on every coin reward.' },
  ...
  { name:'Silver Bonus', emoji:'🥈', type:'badge', effect:'+20% on all payouts',
    ...
    image:'silver.png', description:'Permanent 20% bonus on every coin reward.' },
  ...
  { name:'Golden Bonus', emoji:'🥇', type:'badge', effect:'+30% on all payouts',
    ...
    image:'gold.png', description:'Permanent 30% bonus on every coin reward.' },
  ...
  { name:'Platinum Booster', emoji:'🏆', type:'badge', effect:'+50% on all payouts',
    ...
    image:'platinum.png', description:'Permanent 50% bonus on every coin reward.' }
];
